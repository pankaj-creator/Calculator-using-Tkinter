# -*- coding: utf-8 -*-
"""
Created on Fri Oct  2 17:33:32 2020

@author: Pankaj-Creator
"""
#!/usr/bin/python3

# Import the libraries that are in use - tkinker and math
from tkinter import *
...
Here, we are creating our class, Window, and inheriting from the Frame.
 and Frame is a class from the tkinter module. (see Lib/tkinter/__init__)
"""
class Window(Frame):
    ...
    def init_window(self):
        ...
        message = lambda : messagebox.showinfo(title="About", message="Fully functional Calculator")
        message2 = lambda : messagebox.showinfo(title="Help", message="Made by: Pankaj Kumar Gond")
...
# Create an instance that allows the window class to use tkinter
app = Window(root)
app.pack()

# Extra code for GUI goes between root - Tk() and mainloop()
# Set the functionalities of the Calculator.
def key(event):
